...
class BarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post bars_url, params: { bar: { about: @bar.about, bar_name: @bar.bar_name, owner_id: @bar.owner_id } }
    end
  ...
  test "should update bar" do
    patch bar_url(@bar), params: { bar: { about: @bar.about, bar_name: @bar.bar_name, owner_id: @bar.owner_id } }
